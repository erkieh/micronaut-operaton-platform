...
1. Trigger the release
   1. Open https://github.com/operaton/operaton/releases
...
2. Check Maven Central (Portal)
   1. The new release should appear on https://central.sonatype.com/publishing/deployments after a few minutes in state "Published" and also on https://central.sonatype.com/search?q=micronaut-operaton-bpm-feature
   2. Update README.md
...
4. Update Micronaut Launch in starter-core project
   1. Update version number of micronaut-operaton-bpm-feature
   2. Update version number of operaton-bpm-assert (if changed)
