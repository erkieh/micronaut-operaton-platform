...
import info.novatec.micronaut.operaton.bpm.feature.eventing.EventingPublisherPlugin
import info.novatec.micronaut.operaton.bpm.feature.eventing.ExecutionEvent
...
class EventingPublisherPluginTest {
    ...
    @MicronautTest
    @Property(name = "operaton.eventing.execution", value = "true")
    @Property(name = "operaton.eventing.task", value = "true")
    @Property(name = "operaton.eventing.history", value = "true")
    @Nested
