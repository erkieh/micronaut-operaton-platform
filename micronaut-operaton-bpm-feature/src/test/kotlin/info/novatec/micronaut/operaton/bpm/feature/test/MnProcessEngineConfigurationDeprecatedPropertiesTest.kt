...
/**
 * Deprecated property tests for [info.novatec.micronaut.operaton.bpm.feature.MnProcessEngineConfiguration].
 *
...
class MnProcessEngineConfigurationDeprecatedPropertiesTest {
    ...
    fun `valid property starts the application`() {
        val properties = Collections.singletonMap<String, Any>("operaton.generic-properties.properties.dmn-enabled", true)
