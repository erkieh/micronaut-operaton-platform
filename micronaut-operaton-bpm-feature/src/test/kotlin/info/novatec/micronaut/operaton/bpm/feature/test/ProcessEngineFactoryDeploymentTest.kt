...
import info.novatec.micronaut.operaton.bpm.feature.initialization.DeployModelsExecutor
...
class ProcessEngineFactoryDeploymentTest {
    ...
    inner class SimpleDeployment {
        ...
        @Test
        fun `operaton forms get deployed`() {
    ...
    @MicronautTest
    @Property(name="operaton.locations", value="classpath:.,classpath:bpm")
    @Nested
