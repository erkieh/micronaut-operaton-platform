...
import info.novatec.micronaut.operaton.bpm.feature.tx.MnTransactionContextFactory;
import info.novatec.micronaut.operaton.bpm.feature.tx.MnTransactionInterceptor;
...
public class MnProcessEngineConfiguration extends ProcessEngineConfigurationImpl {
        ...
        protected final OperatonVersion operatonVersion;
        ...
        public MnProcessEngineConfiguration(SynchronousTransactionManager<Connection> transactionManager,
                                            ...
                                            OperatonVersion operatonVersion,
            ...
            this.operatonVersion = operatonVersion;
        ...
        protected void checkForDeprecatedConfiguration() {
            if (!environment.getPropertyEntries("camunda").isEmpty()) {
                String msg = "All properties with the prefix 'camunda.*' have been renamed to 'operaton.*'. Please update your configuration!";
                log.error(msg);
