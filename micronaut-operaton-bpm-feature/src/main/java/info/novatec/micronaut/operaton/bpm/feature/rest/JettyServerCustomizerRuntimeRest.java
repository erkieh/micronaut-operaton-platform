 ...
 */
package info.novatec.micronaut.operaton.bpm.feature.rest;
...
import static info.novatec.micronaut.operaton.bpm.feature.Configuration.Rest.DEFAULT_AUTHENTICATION_PROVIDER;
...
@Requires(property = "operaton.rest.enabled", value = "true")
