 ...
 */
@MicronautTest
@Property(name = "operaton.webapps.context-path", value = "/custom-webapp-path")
@Property(name = "operaton.webapps.index-redirect-enabled", value = "false")
@Property(name = "operaton.rest.context-path", value = "/custom-rest-path")
